...
public class DateUtils {
    ...
    public static long dateFormatToLong2(String date) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
        Date d = null;
        try {
            d = sdf.parse(date);
	...
	public static String getTimeStamp() {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");// 二十四时制
	...
	public static String getCurrentDay() {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");// 二十四时制
		return sdf.format(new Date());
	}
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			System.out.println(DateUtils.dateToStrLong(new Date(1438325117829L)));
		} catch (Exception e) {
			throw new Exception();
		}
	}
