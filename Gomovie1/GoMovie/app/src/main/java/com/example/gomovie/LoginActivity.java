	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case Const.LOGIN_SUCCESS:
				...
				Log.i(TAG, "====++++++++++++++++==="+ msg.obj);
				MySharedPreference.setName(username, LoginActivity.this);
			...
			case Const.LOGIN_FAIL_USERNAME:
				Toast.makeText(getApplicationContext(), "User name does not exist, login failed！",
				Toast.LENGTH_SHORT).show();
				break;
			case Const.LOGIN_FAIL_PASSWORD:
				Toast.makeText(getApplicationContext(), "Password error, login failure！",
						Toast.LENGTH_SHORT).show();
				break;
			}
		}
							...
							if (responseCode == 200) {
								...
								try {
									...
									if (code == 1) {
										...
										Log.d(TAG, "url = " + email);
										MySharedPreference.setId(id, LoginActivity.this);
										MySharedPreference.setAge(age, LoginActivity.this);
										MySharedPreference.setEmail(email, LoginActivity.this);
