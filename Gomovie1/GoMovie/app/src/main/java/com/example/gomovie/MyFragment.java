...
public class MyFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		String username = (String)mySharedPreference.getName(this.getActivity());
//		if (username!="") {
//			login.setText(username);
//			if (!username.equals("Login/Register")) {
//				// login.setClickable(false);
//				// TODO 退出登陆的操作
//			}
//		}
		Integer id = (Integer)MySharedPreference.getId(this.getActivity());
		if (id == 0){
		...
		logout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				MySharedPreference.setId(0,getActivity());
				Intent intent = new Intent(getActivity(),
						MainActivity.class);
				startActivityForResult(intent, 2);
			}
		...
		exit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// 3)设置内容
				builder.setMessage("Are you sure you want to quit GoMovie?");
				// 4)设置按钮
				builder.setPositiveButton("Yes, I want to quit.",
				...
				builder.setNegativeButton("Sorry, mistaken clicked.",
						new DialogInterface.OnClickListener() {
