...
public class Ticket {
        ...
        // 利用模板生成pdf
        public void pdfout(Map<String,Object> map,String templatePath, String newPDFPath) {
            // 模板路径
            File file = new File(Environment.getExternalStorageDirectory(), templatePath);
            File file1 = new File(Environment.getExternalStorageDirectory(), newPDFPath);
            //String templatePath = "@drawable/payed_ticket";
            // 生成的新文件路径
            //String newPDFPath = "@drawable/payed.pdf";
            PdfReader reader;
            ...
            ByteArrayOutputStream bos;
                ...
                try {
                    ...
                    //out = manager.open("payed_ticket.pdf");
                ...
                form.setField("movie", "The Fast and the Furious");
                //ticket time
        ...
        public void main( String templatePath, String newPDFPath) {
            //条形码map
            Map<String,Object> barcodeFields = new HashMap<String, Object>();
            barcodeFields.put("bar","04171180308");
            //二维码mapnewPDFPath
